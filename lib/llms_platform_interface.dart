...
import "llms_method_channel.dart";

abstract class llmsPlatform extends PlatformInterface {
  /// Constructs a llmsPlatform.
  ...
  /// The default instance of [llmsPlatform] to use.
  ///
  /// Defaults to [MethodChannelllms].
  static llmsPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [llmsPlatform] when
