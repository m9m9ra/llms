...
/// An implementation of [llmsPlatform] that uses method channels.
class MethodChannelllms extends llmsPlatform {
  /// The method channel used to interact with the native platform.
  final methodChannel = const MethodChannel("llms");
  final eventChannel = const EventChannel("llms_event_channel");
